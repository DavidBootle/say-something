...
<template>
    <div class="topic-box-container">
        ...
        <textarea id="opinion-input" v-model="opinionText" :class="{ invalid: invalidInput }"></textarea>
        <p v-if="invalidInput" id="invalid-input-text">Your message cannot be empty</p>
...
.topic-box-container textarea.invalid {
    border: solid darkred;
}

p#invalid-input-text {
    color: darkred;
    font-family: sans-serif;
    margin: 0.4rem 0 0 0;
    padding: 0;
...
button#say-it-button:hover, button#say-it-button:focus-visible {
    box-shadow: 0 0 0 0.2rem #AAA;
}

button#say-it-button:active {
